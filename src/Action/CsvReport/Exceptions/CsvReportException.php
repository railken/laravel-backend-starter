...
namespace Action\CsvReport\Exceptions;

use Exception;
use Railken\Laravel\Manager\Contracts\ExceptionContract;

abstract class CsvReportException extends Exception implements ExceptionContract
{
    /**
     ...
     * @var string
     */
    protected $code = 'CSVREPORT_ERROR';
