...
namespace Action\Notification\Exceptions;

use Exception;
use Railken\Laravel\Manager\Contracts\ExceptionContract;

abstract class NotificationException extends Exception implements ExceptionContract
{
    /**
     ...
     * @var string
     */
    protected $code = 'NOTIFICATION_ERROR';
