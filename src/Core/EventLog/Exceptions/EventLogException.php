...
namespace Core\EventLog\Exceptions;

use Exception;
use Railken\Laravel\Manager\Contracts\ExceptionContract;

abstract class EventLogException extends Exception implements ExceptionContract
{
    /**
