...
namespace Core\HttpLog\Exceptions;

use Exception;
use Railken\Laravel\Manager\Contracts\ExceptionContract;

abstract class HttpLogException extends Exception implements ExceptionContract
{
    /**
