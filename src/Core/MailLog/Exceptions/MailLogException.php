...
namespace Core\MailLog\Exceptions;

use Exception;
use Railken\Laravel\Manager\Contracts\ExceptionContract;

abstract class MailLogException extends Exception implements ExceptionContract
{
    /**
