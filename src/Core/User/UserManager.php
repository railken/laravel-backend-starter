...
class UserManager extends ModelManager
{
    ...
    protected $attributes = [
        ...
        Attributes\TaxCode\TaxCodeAttribute::class,
        Attributes\Residence1Id\Residence1IdAttribute::class,
        Attributes\Residence2Id\Residence2IdAttribute::class,
        Attributes\FileDocFrontId\FileDocFrontIdAttribute::class,
        Attributes\FileDocBackId\FileDocBackIdAttribute::class,
        Attributes\FileHealthCardId\FileHealthCardIdAttribute::class,
        Attributes\FileAvatarId\FileAvatarIdAttribute::class,
        Attributes\Phone\PhoneAttribute::class,
        Attributes\SponsorFirstname\SponsorFirstnameAttribute::class,
        Attributes\SponsorLastname\SponsorLastnameAttribute::class,
        Attributes\DocIdCode\DocIdCodeAttribute::class,
        Attributes\DocIdReleasedFrom\DocIdReleasedFromAttribute::class,
        Attributes\DocIdReleasedDate\DocIdReleasedDateAttribute::class,
        Attributes\KitNumber\KitNumberAttribute::class,
        Attributes\Iban\IbanAttribute::class,
        Attributes\BirthCity\BirthCityAttribute::class,
        Attributes\BirthProvince\BirthProvinceAttribute::class,
        Attributes\BirthDay\BirthDayAttribute::class,
        Attributes\Income\IncomeAttribute::class,
        Attributes\PensionType\PensionTypeAttribute::class,
        Attributes\PublicEmploymentType\PublicEmploymentTypeAttribute::class,
        Attributes\Tos1\Tos1Attribute::class,
        Attributes\Tos2\Tos2Attribute::class,
        Attributes\Tos3\Tos3Attribute::class,
        Attributes\Tos4\Tos4Attribute::class,
        Attributes\Tos5\Tos5Attribute::class,
        Attributes\Tos6\Tos6Attribute::class,
        Attributes\VatNumber\VatNumberAttribute::class,
        Attributes\Enabled\EnabledAttribute::class,
        Attributes\Moderated\ModeratedAttribute::class,
        Attributes\Uid\UidAttribute::class,
        Attributes\ValidFromAt\ValidFromAtAttribute::class,
        Attributes\ValidToAt\ValidToAtAttribute::class,
    ];
